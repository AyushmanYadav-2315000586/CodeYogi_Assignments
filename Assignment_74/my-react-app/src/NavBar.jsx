...
function NavBar({ productCount, user, onLogout }) {
  return (
      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        ...
        <div className="flex gap-5">
          {user ? (
            ...
            <>
              <button className="bg-amber-200 px-2 py-1 rounded-md text-purple-600 hover:bg-amber-300 transition">
                <Link to="/login">Login</Link>
              </button>
              <button className="bg-purple-600 px-2 py-1 rounded-md text-amber-200 hover:bg-purple-700 transition">
